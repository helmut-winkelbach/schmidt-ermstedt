...
/*
 * This file is part of the  schmidt_ermstedt.
 *
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:schmidt_ermstedt/Resources/Private/Language/Backend.xlf:content_element.timeline',
        'timeline',
...
$GLOBALS['TCA']['tt_content']['types']['timeline'] = array_replace_recursive(
    ...
    [
        'showitem' => '
            ...
            --div--;LLL:EXT:schmidt_ermstedt/Resources/Private/Language/Backend.xlf:timeline.options,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_bootstrappackage_timeline_item' => [
            'label' => 'LLL:EXT:schmidt_ermstedt/Resources/Private/Language/Backend.xlf:timeline_item',
            'config' => [
                'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:schmidt_ermstedt/Configuration/FlexForms/Timeline.xml',
    'timeline'
);
